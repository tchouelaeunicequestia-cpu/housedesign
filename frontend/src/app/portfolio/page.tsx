      ...
      <div>
        ...
        <section className="bg-slate-900 text-white py-16 px-6 text-center border-b border-slate-800">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-4xl font-extrabold mt-4 mb-3 text-white">Our Project Portfolio</h2>
            <p className="text-slate-400 text-base">
              Professional residential, commercial, and industrial engineering solutions.
            </p>
          </div>
        </section>
